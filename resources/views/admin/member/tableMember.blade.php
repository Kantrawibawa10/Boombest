        ...
        <div class="navbar-menu-wrapper d-flex align-items-center justify-content-end bg-success">
            <ul class="navbar-nav mr-lg-4 w-100">
                <li class="nav-item nav-search d-none d-lg-block w-100">
                    <form action="{{ url("/memberaktif/searchmember") }}" method="GET" class="search cari">
        ...
        <div class="row">
			...
			<a class="btn btn-secondary py-2 px-4 bg-white border-0 text-dark shadow-none font-weight-medium" href="{{ route('memberExpired') }}">
                        ...
                        <a class="py-2 px-4 border-0 text-dark shadow-none font-weight-medium float-right" href="{{ route('memberAktif') }}">
                            <span class="mb-0 d-inline-block" style="font-size: 20px">Table Semua Member</span>
                        </a>
                    ...
                    <table class="table myaccordion table-hover" id="accordion">
                      ...
                      <tbody>
                        ...
                        <tr data-toggle="collapse" data-target="#collapseTwo{{ $item->id }}" aria-expanded="false" aria-controls="collapseTwo" class="collapsed">
                          ...
                          <td class="p-2" style="font-size: 12px;">
                            <!--edit-->
                            <a href="/memberaktif/editmember/{{ $item->id_member }}" style="cursor:pointer;" class="icon-aksi"> <box-icon type='solid' name='pencil' class="bg-warnig text-white"></box-icon></a>
                          </td>
