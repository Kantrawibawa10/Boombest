            ...
            <div class="col-md-12">
                ...
                <ul class="navbar-nav navbar-nav-right">
                    <li class="dropdown">
                        ...
                        <a class="btn btn-secondary py-2 px-4 bg-white border-0 text-dark shadow-none font-weight-medium" href="{{ route('memberPlatinum') }}">
                            <span class="mb-0 d-inline-block" style="font-size: 12px">Platinum</span>
                        </a>

                        <a class="btn btn-secondary py-2 px-4 bg-white border-0 text-dark shadow-none font-weight-medium" href="{{ route('memberBiasa') }}">
                            <span class="mb-0 d-inline-block" style="font-size: 12px">Member</span>
                        </a>

                        <a class="btn btn-primary bg-primary py-2 px-4 bg-white border-0 text-white shadow-none font-weight-medium active" href="{{ route('memberExpired') }}">
                            <span class="mb-0 d-inline-block" style="font-size: 12px">Member Proses</span>
                        </a>

                        <a class="py-2 px-4 border-0 text-dark shadow-none font-weight-medium float-right" href="{{ route('memberExpired') }}">
                            <span class="mb-0 d-inline-block" style="font-size: 20px">Table Member Proses</span>
                        </a>
