    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <ul class="navbar-nav navbar-nav-right">
                    <li class="dropdown">
                        ...
                        <a class="btn btn-secondary py-2 px-4 bg-primary border-0 text-white shadow-none font-weight-medium" href="{{ route('memberPlatinum') }}">
			...
			<a class="btn btn-secondary py-2 px-4 bg-white border-0 text-dark shadow-none font-weight-medium" href="{{ route('memberExpired') }}">
                        ...
                        <a class="py-2 px-4 border-0 text-dark shadow-none font-weight-medium float-right" href="{{ route('memberPlatinum') }}">
                            <span class="mb-0 d-inline-block" style="font-size: 20px">Table Platinum Member</span>
                        </a>
