        ...
        <div class="navbar-menu-wrapper d-flex align-items-center justify-content-end bg-success">
            <ul class="navbar-nav mr-lg-4 w-100">
                <li class="nav-item nav-search d-none d-lg-block w-100">
                    <form action="{{ url("/searchpoint") }}" method="GET" class="search cari">
                    ...
                    <div class="d-flex flex-wrap justify-content-xl-between">
                      ...
                      <div class="d-flex border-md-right flex-grow-1 align-items-center justify-content-center p-3 item">
                        ...
                        <div class="d-flex flex-column justify-content-around pt-3" style="line-height: 6px">
                          ...
                          <h5 class="mr-2 mb-0 text-success" style="font-size: 25px;">{{ $users->count() }}</h5>
                        </div>
                      </div>
    ...
    <div class="container">
		...
		<div class="d-flex">
                    <div class="col-3" style="margin-left: -15px;">
                        <form action="{{ url("/pointmember/namamember") }}" method="GET" class="d-flex">
                    ...
                    <div class="col-2" style="margin-left: -25px;">
                        <form action="{{ url("/pointmember/noregister") }}" method="GET" class="d-flex">
                    ...
                    <div class="col-2" style="margin-left: -25px;">
                        <form action="{{ url("/pointmember/noreferal") }}" method="GET" class="d-flex">
                    ...
                    <div class="col-2" style="margin-left: -25px;">
                        <form action="{{ url("/pointmember/daftar") }}" method="GET" class="d-flex">
                    ...
                    <div class="col-2" style="margin-left: -3px;">
                        <form action="{{ url("/pointmember/expired") }}" method="GET" class="d-flex">
                    ...
                    <div class="col-2" style="margin-left: -3px;">
                        <form action="{{ url("/pointmember/group") }}" method="GET" class="d-flex">
			...
			<tr data-toggle="collapse" data-target="#collapseTwo{{ $item->id }}" aria-expanded="false" aria-controls="collapseTwo" class="collapsed">
                          ...
                          <td class="p-2 col-2" style="font-size: 12px;">{{ $item->reg_reff }}</td>
                          @if($item->point_reg == '')
                          <td class="p-2 text-warning" style="font-size: 30px;">0</td>
                          @else
                        ...
                        <tr>
                            <td colspan="12" id="collapseTwo{{ $item->id }}" class="collapse acc bg-white" data-parent="#accordion">
                                <div class="d-flex mx-5">
                                    <div class="">
                                        @if( $item->image  == '')
                                        <div class="img" style="background-image: url('/assets/img/test.png'); background-size: cover; background-position: center; width: 400px; height: 300px; border-radius: none;"></div>
                                        @else
