          ...
          <div class="d-flex justify-content-between flex-wrap">
            <div class="d-flex align-items-end flex-wrap">
              <div class="mr-md-3 mr-xl-5">
                ...
                <p class="mb-md-0">Silakan Edit Produk Anda di Sini.</p>
              </div>
            </div>
          </div>
        </div>
            ...
            <div class="col-md-12 grid-margin">
			   ...
			   <div class="d-flex">
			      ...
			      <div class="mb-3 col-md-6">
                                ...
                                <input type="number" class="form-control" name="wa" id="wa" placeholder="+62,..." value="{{ $item->wa }}">
        ...
        <div class="modal fade" id="batal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-danger" data-dismiss="modal">Tidak</button>
                        <a href="{{route('produksaya')}}" class="btn btn-success">Iya</a>
                    </div>
                </div>
            </div>
        </div>
